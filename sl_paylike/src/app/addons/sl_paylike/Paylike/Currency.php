...
class Currency {
    ...
    public static function getPaylikeCurrencyMultiplier( $currency_iso_code ) {
        $currency = self::getPaylikeCurrency( $currency_iso_code );
    ...
    public static function getPaylikeCurrency( $currency_iso_code ) {
    ...
    public static function getCurrenciesList() {
        $currencies = self::getCurrencies();
        $out = [];
        foreach($currencies as $c => $info) {
            $out[$c] = $info['currency'];
        }
        return $out;
    }

    public static function toPaylikeCurrency($total, $multiplier) {
